...
int main() {
    try {
        ...
        system.addUser(std::make_unique<Student>("Ivan", 101, 1, "GR-101"));
        system.addUser(std::make_unique<Teacher>("Olga", 202, 3, "Physics"));
        system.addUser(std::make_unique<Administrator>("Alexander", 303, 5, "IT"));
